# Exercícios retirados do livro Manual de análise de dados: estatística e modelagem multivariada com excel, SPSS e stata realizados utilizando a linguagem Python no Google Colab
